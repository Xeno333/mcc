...
//Lib defined
    //print error
    extern void error(const char* errors, bool self);
    extern char* get_chara_arg(const int argc, const char** args, const char* argtype);
    // gets args
    extern char* get_args(compiler_args_t* argout, const int argc,const char** args);
    // print mcc <name @ version>
    extern int printself(void);
    //list_supported_langs
    extern int list_supported_langs(void);
    //list_supported_formats
    extern int list_supported_formats(void);
    //list_supported_archs
    extern int list_supported_archs(void);
    //list_supported_opts
    extern int list_supported_opts(void);
    //help
    extern int help(void);
    extern int fsize(const char* fn);
    extern char* fget(const char* fn);
    extern int man(const char* manfn);
...
//Lang compiler hooks
    extern int cesium_main(const compiler_args_t args);
    extern int hrriscasm_main(const compiler_args_t args);
